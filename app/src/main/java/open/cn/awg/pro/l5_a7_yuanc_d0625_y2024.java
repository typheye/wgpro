...
import i.app.iActivity;
 import android.view.Window; import com.ypz.bangscreentools.BangScreenTools; import java.io.File; import android.view.View; import android.content.Intent; import android.os.Build; import android.content.Context; import android.net.Uri; import java.lang.Exception; import android.provider.Settings;import java.lang.*;

public class l5_a7_yuanc_d0625_y2024 extends iActivity {
...
aa=open.cn.awg.pro.SystemAccessibilityService.isAccessibilitySettingsOn(lei,open.cn.awg.pro.SystemAccessibilityService.class.getName());
...
if(carton.state(((android.content.Context)(lei)))&&aa){
...
if(carton.state(((android.content.Context)(lei)))){
...
carton.gets(((android.content.Context)(lei)));
...
__layoutIsLoaded(ay, vw);
    ...
    public final l5_a7_yuanc_d0625_y2024 lei = this, 类 = this;
}
