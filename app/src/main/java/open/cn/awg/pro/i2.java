...
import i.app.iActivity;
 import android.graphics.Bitmap; import java.lang.Integer; import android.content.pm.ActivityInfo; import android.view.WindowManager; import android.view.Window; import android.os.Build; import android.view.View; import java.lang.reflect.Field; import java.lang.reflect.Method; import com.ypz.bangscreentools.BangScreenTools; import android.view.inputmethod.InputMethodManager; import java.text.ParseException; import android.app.Activity;import java.lang.*;

public class i2 extends iActivity {
...
public open.cn.awg.pro.e10  e10=new e10(_APPINFO);
...
if(wj.cz(sjhc)==true&&!zf.dy(wj.dqwb(sjhc),"")){
...
if(wj.cz("/data/user/0/open.cn.awg.pro/data/ltlb/disTouch")==false){
...
public void run(){
				...
				InputMethodManager imm = (InputMethodManager) lei.getSystemService(lei.INPUT_METHOD_SERVICE);
...
if(wj.cz(path)==true&&!zf.dy(wj.dqwb(path),"")&&!zf.dy(wj.dqwb(path),"null")&&zf.dy(an.tszf(),"选择文件")){
...
private android.view.View.OnClickListener $_on_setOnClickListener_d2a1859abe=new android.view.View.OnClickListener(){
...
private android.view.View.OnTouchListener $_on_setOnTouchListener_i84f04cd47e=new android.view.View.OnTouchListener(){
...
private android.view.View.OnClickListener $_on_setOnClickListener_i3295d3c478=new android.view.View.OnClickListener(){
...
private android.view.View.OnClickListener $_on_setOnClickListener_fb3bffd427=new android.view.View.OnClickListener(){
...
private android.widget.CompoundButton.OnCheckedChangeListener $_on_setOnCheckedChangeListener_i4b3a71b80a=new android.widget.CompoundButton.OnCheckedChangeListener(){
...
private android.view.View.OnLongClickListener $_on_setOnLongClickListener_ff56a8e7f6=new android.view.View.OnLongClickListener(){
...
private android.view.View.OnTouchListener $_on_setOnTouchListener_e76307d04a=new android.view.View.OnTouchListener(){
...
private androidx.recyclerview.widget.RecyclerView.OnScrollListener $_on_addOnScrollListener_c2f5ccfa3a=new androidx.recyclerview.widget.RecyclerView.OnScrollListener(){
...
__layoutIsLoaded(ay, vw);
    ...
    public final i2 lei = this, 类 = this;
}
