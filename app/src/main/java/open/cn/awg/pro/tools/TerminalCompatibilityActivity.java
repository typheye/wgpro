...
public class TerminalCompatibilityActivity extends iActivity {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i0afd0fa55f = new android.view.View.OnClickListener() {
