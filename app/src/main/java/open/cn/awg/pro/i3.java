...
import i.app.iActivity;
 import android.view.WindowManager; import android.view.Window; import com.ypz.bangscreentools.BangScreenTools; import android.view.View;import java.lang.*;

public class i3 extends iActivity {
...
if(!zf.dy(luid,"0")&&wj.cz(userid)==true&&!zf.dy(wj.dqwb(userid),"")&&zf.dy(luid,wj.dqwb(userid))||zf.dy(uid,"110")||zf.dy(uid,"404")){
...
__layoutIsLoaded(ay, vw);
    ...
    public final i3 lei = this, 类 = this;
}
