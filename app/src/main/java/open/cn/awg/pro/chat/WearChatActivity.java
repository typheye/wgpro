...
public class WearChatActivity extends BaseAwgActivity {
    ...
    public void onCreate(Bundle be) {
        super.onCreate(be);
        setContentView(R.layout.wear_chat);
    ...
    public void __layoutIsLoaded(Activity ay, View vw) {
        ...
        applyStandardScreenMode(R.id.wear_chat_root, R.id.xdbj1, R.id.title_bar);
