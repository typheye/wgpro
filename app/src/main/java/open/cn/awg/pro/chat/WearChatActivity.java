/**
 ******************************************************************************
 * @file    WearChatActivity.java
 * @author  Typheye
 * @brief   Shows WearChat room list and chat entry points.
 ******************************************************************************
 * @attention
 *
...
public class WearChatActivity extends iActivity {

    public static java.lang.String betaurl = "";
    public final WearChatActivity lei = this, 类 = this;
    ...
    public void onCreate(android.os.Bundle be) {
        super.onCreate(be);
        setContentView(open.cn.awg.pro.R.layout.i1);
    ...
    public void __layoutIsLoaded(android.app.Activity ay, android.view.View vw) {
        ...
        if (zf.dy(a, "4")) {
            ...
            st.xdbj(open.cn.awg.pro.R.id.i1_v).shxtck(true);
            ...
            st.xdbj(open.cn.awg.pro.R.id.i1_v).shxtck(false);
    ...
    private void $_onClick_dc32622ccd(android.view.View vw) {
        e1.tsk("提示", "当前在线人数统计，以下数据来自服务器\n\n" + st.wb(open.cn.awg.pro.R.id.wb24).zf() + "\n\n您可以通过\"刷新\"来更新此数据");
