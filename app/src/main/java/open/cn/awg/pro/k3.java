...
import i.app.iActivity;
 import android.view.Window; import com.ypz.bangscreentools.BangScreenTools; import android.widget.TextView; import android.text.method.ScrollingMovementMethod; import android.view.View; import com.tananaev.adblib.AdbStream; import com.tananaev.adblib.AdbConnection; import com.tananaev.adblib.AdbCrypto; import java.net.Socket; import android.util.Base64; import java.lang.StringBuilder; import com.tananaev.adblib.AdbBase64; import java.io.BufferedReader; import java.io.BufferedWriter; import java.io.InputStream; import java.io.InputStreamReader; import java.io.OutputStreamWriter; import java.util.Scanner; import android.os.Build;import java.lang.*;
...
cmd.st.append(((java.lang.CharSequence)("扫描结束,开始安装")));
...
cmd.st.append(((java.lang.CharSequence)("安装完成,结束任务")));
cmd.st.append(((java.lang.CharSequence)("\n")));
qtgd.st.fullScroll(View.FOCUS_DOWN);
jzt.zf("安装完成");
