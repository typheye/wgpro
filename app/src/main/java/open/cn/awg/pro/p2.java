...
import i.app.iActivity;
 import android.view.Window; import com.ypz.bangscreentools.BangScreenTools; import java.io.File; import android.view.View; import java.lang.System;import java.lang.*;
...
final boolean vv_yysfaz=com.kingqi.zwcj.应用工具.应用是否安装(((android.content.Context)(lei)),v_id);

final long vv_yybbh=com.kingqi.zwcj.应用工具.获取应用版本号(((android.content.Context)(lei)),v_id);
...
com.kingqi.zwcj.应用工具.启动应用(((android.content.Context)(lei)),v_id);
...
private android.view.View.OnClickListener $_on_setOnClickListener_f1070075ac=new android.view.View.OnClickListener(){
