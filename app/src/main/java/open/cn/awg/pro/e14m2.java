...
public class e14m2 extends iClass {
...
if(e14.newG(Integer.parseInt(id))==true){
...
open.cn.awg.pro.easy  easy=new easy(_APPINFO);
...
if(easy.register$request(bjk1.zf(),bjk2.zf(),bjk3.zf(),bjk4.zf())==true){
...
if(e10.part_buildNewRoom(bjk1.zf(),bjk2.zf())==true){
...
if(e14.part_buildNewPlu(bjk1.zf(),bjk2.zf(),bjk3.zf())==true){
...
if(easy.findpwd(bjk1.zf(),bjk2.zf(),bjk3.zf(),bjk4.zf())==true){
...
public e14m2(i.runlibrary.app.AppInfo _APPINFO){
super(_APPINFO);

}

    public final e14m2 lei = this, 类 = this;
}
