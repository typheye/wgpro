...
public class VideoPlayerActivity extends iActivity {
    ...
    private final android.view.View.OnLongClickListener $_on_setOnLongClickListener_fc1598ee09 = new android.view.View.OnLongClickListener() {
    ...
    private final android.view.View.OnTouchListener $_on_setOnTouchListener_i28d59c5074 = new android.view.View.OnTouchListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i6614d6d216 = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnTouchListener $_on_setOnTouchListener_a6dab51133 = new android.view.View.OnTouchListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_f71caff030 = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i263afb26ad = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_f3906a9028 = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i66be67e25d = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i689cfe9338 = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i0924d0fe5d = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_cce8454c0e = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i90adf494fc = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_f2c0485bfc = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_dc32622ccd = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i91cc1b9bf5 = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i16d7dc6512 = new android.view.View.OnClickListener() {
    ...
    private final android.view.View.OnLongClickListener $_on_setOnLongClickListener_i464e6cc6fb = new android.view.View.OnLongClickListener() {
    ...
    private final android.view.View.OnClickListener $_on_setOnClickListener_i464e6cc6fb = new android.view.View.OnClickListener() {
        ...
        try {
            ...
            gj.xc(new java.lang.Thread() {
                ...
                public void run() {
                    ...
                    Context context = open.cn.awg.pro.app.AwgProApplication.getContext();
                    ...
                    if (!zf.dy(url, null) && !zf.dy(url, "")) {
                        ...
                        if (zf.cjw(url, ".mp3") || zf.cjw(url, ".flac") || zf.cz(url, ".mp3?") || zf.cz(url, ".flac?")) {
                            ...
                            gj.jmxc(new java.lang.Runnable() {
                                ...
                                public void run() {
                                    ...
                                    st.appInfo.st(open.cn.awg.pro.R.id.video_v2).setVisibility(View.GONE);
                                    isMusic = true;
                        ...
                        mPlayer = lei.findViewById(R.id.video_v2);
