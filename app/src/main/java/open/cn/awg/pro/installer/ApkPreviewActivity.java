...
public class ApkPreviewActivity extends iActivity {
    ...
    public void onCreate(android.os.Bundle be) {
        ...
        try {
            ...
            android.widget.TextView textView = findViewById(R.id.wb1);
            String Apk_Path = url;
    ...
    public void run() {
        gj.xc(new java.lang.Thread() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(lei, open.cn.awg.pro.installer.ApkInstallerActivity.class);
