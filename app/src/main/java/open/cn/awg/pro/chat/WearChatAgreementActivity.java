/**
 ******************************************************************************
 * @file    WearChatAgreementActivity.java
 * @author  Typheye
 * @brief   Shows the WearChat usage agreement.
 ******************************************************************************
 * @attention
 *
...
public class WearChatAgreementActivity extends iActivity {

    public final WearChatAgreementActivity lei = this, 类 = this;
    ...
    public void onCreate(android.os.Bundle be) {
        super.onCreate(be);
        setContentView(open.cn.awg.pro.R.layout.i4);
    ...
    public void __layoutIsLoaded(android.app.Activity ay, android.view.View vw) {
        ...
        if (zf.dy(a, "4")) {
            ...
            st.xdbj(open.cn.awg.pro.R.id.i4_v).shxtck(true);
            ...
            st.xdbj(open.cn.awg.pro.R.id.i4_v).shxtck(false);
        ...
        java.lang.String t1 = wj.dqwb("/data/user/0/open.cn.awg.pro/data/assets/a20");
        st.wb(open.cn.awg.pro.R.id.wb1).zf(t1);
