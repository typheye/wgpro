...
public class f4 extends iActivity {

public void onCreate(android.os.Bundle be){
super.onCreate(be);
setContentView(open.cn.awg.pro.R.layout.f4);
...
st.xdbj(open.cn.awg.pro.R.id.f4_v).shxtck(true);
...
st.xdbj(open.cn.awg.pro.R.id.f4_v).shxtck(false);
...
java.lang.String set3="/data/user/0/open.cn.awg.pro/settings/set3.inf";
...
st.wb(open.cn.awg.pro.R.id.wb28).zf("应用暂无产生缓存");
...
st.wb(open.cn.awg.pro.R.id.wb28).zf("将清除"+CacheSize+"的缓存");
...
java.lang.String te=st.wb(open.cn.awg.pro.R.id.wb35).zf();
...
java.lang.String lj=st.wb(open.cn.awg.pro.R.id.wb23).zf();
e1.tsk("详细信息","[名称]\n"+te+"\n\n[简介]\n"+lj);
return true;
...
java.lang.String lj=st.wb(open.cn.awg.pro.R.id.wb32).zf();
e1.tsk("详细信息","[名称]\n"+te+"\n\n[简介]\n"+lj);
return true;
...
java.lang.String lj=st.wb(open.cn.awg.pro.R.id.wb38).zf();
e1.tsk("详细信息","[名称]\n"+te+"\n\n[简介]\n"+lj);
return true;
...
java.lang.String te=st.wb(open.cn.awg.pro.R.id.wb39).zf();

java.lang.String lj=st.wb(open.cn.awg.pro.R.id.wb40).zf();
e1.tsk("详细信息","[名称]\n"+te+"\n\n[简介]\n"+lj);
return true;
...
if(zf.dy(st.wb(open.cn.awg.pro.R.id.wb28).zf(),"应用暂无产生缓存")){
...
__layoutIsLoaded(ay, vw);
    ...
    public final f4 lei = this, 类 = this;
}
