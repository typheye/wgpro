...
public class l1 extends iActivity {

public void onCreate(android.os.Bundle be){
super.onCreate(be);
setContentView(open.cn.awg.pro.R.layout.l1);
...
st.xdbj(open.cn.awg.pro.R.id.l1_v).shxtck(true);
...
st.xdbj(open.cn.awg.pro.R.id.l1_v).shxtck(false);
...
__layoutIsLoaded(ay, vw);
    ...
    public final l1 lei = this, 类 = this;
}
