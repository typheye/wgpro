...
carton.setCameraDisabled(((android.content.Context)(lei)),true);
bak(true);
...
carton.setCameraDisabled(((android.content.Context)(lei)),false);
bak(true);
...
carton.setStatusBarDisabled(((android.content.Context)(lei)),true);
bak(true);
...
carton.setStatusBarDisabled(((android.content.Context)(lei)),false);
bak(true);
...
carton.lockNow(((android.content.Context)(lei)));
bak(true);
...
carton.wipeData(((android.content.Context)(lei)));
bak(true);
...
carton.reboot(((android.content.Context)(lei)));
bak(true);
...
boolean e0=carton.isDeviceOwnerApp(((android.content.Context)(lei)));
...
carton.setUninstallBlocked(((android.content.Context)(lei)),apk,true);
bak(true);
...
carton.setUninstallBlocked(((android.content.Context)(lei)),apk,false);
bak(true);
...
carton.setDeviceOwnerLockScreenInfo(((android.content.Context)(lei)),text);
bak(true);
...
carton.setOrganizationName(((android.content.Context)(lei)),text);
bak(true);
...
private android.view.View.OnLongClickListener $_on_setOnLongClickListener_i50b5d2ce90=new android.view.View.OnLongClickListener(){
