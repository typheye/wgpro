/**
 ******************************************************************************
 * @file    LegalInfoActivity.java
 * @author  Typheye
 * @brief   Opens user agreement, permission explanation, and chat convention documents.
 ******************************************************************************
 * @attention
 *
...
public class LegalInfoActivity extends iActivity {

    public final LegalInfoActivity lei = this, 类 = this;
    ...
    public void onCreate(android.os.Bundle be) {
        super.onCreate(be);
        setContentView(open.cn.awg.pro.R.layout.f16);
    ...
    public void __layoutIsLoaded(android.app.Activity ay, android.view.View vw) {
        ...
        if (zf.dy(a, "4")) {
            ...
            st.xdbj(open.cn.awg.pro.R.id.f16_v).shxtck(true);
            ...
            st.xdbj(open.cn.awg.pro.R.id.f16_v).shxtck(false);
    ...
    private void $_onClick_c4cbe9d7ff(android.view.View vw) {
        load("/data/user/0/open.cn.awg.pro/data/assets/b0", "用户协议");
    ...
    private void $_onClick_i3167b45174(android.view.View vw) {
        load("/data/user/0/open.cn.awg.pro/data/assets/b1", "权限使用说明");
    ...
    private void $_onClick_i20c2777fab(android.view.View vw) {
        load("/data/user/0/open.cn.awg.pro/data/assets/b3", "腕上微聊公约");
