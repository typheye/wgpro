...
import i.app.iActivity;
 import android.os.Process; import java.lang.System; import android.graphics.Bitmap; import android.content.pm.ActivityInfo; import android.view.WindowManager; import android.view.Window; import android.os.Build; import android.view.View; import java.lang.reflect.Field; import java.lang.reflect.Method; import com.ypz.bangscreentools.BangScreenTools;import java.lang.*;

public class a3 extends iActivity {

public void onCreate(android.os.Bundle be){
super.onCreate(be);
setContentView(open.cn.awg.pro.R.layout.a3);
_$_viewAutomaticSettingEvent();
open.cn.awg.pro.e6.getInstance().addActivity(lei);

java.lang.String nr=sj.hqtz("text");
st.wb(open.cn.awg.pro.R.id.wb1).zf(nr);
...
st.wb(open.cn.awg.pro.R.id.Tab).zf("< "+bt);


}

java.lang.String qr=sj.hqtz("QR-Code");
qr=zf.qctwkg(qr);
...
try{
			...
			android.widget.ImageView imageView=(android.widget.ImageView)findViewById(R.id.tx1);
...
st.xdbj(open.cn.awg.pro.R.id.a3_v).shxtck(true);
...
st.xdbj(open.cn.awg.pro.R.id.a3_v).shxtck(false);
...
__layoutIsLoaded(ay, vw);
    ...
    public final a3 lei = this, 类 = this;
}
