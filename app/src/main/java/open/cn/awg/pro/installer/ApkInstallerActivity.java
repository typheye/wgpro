/**
 ******************************************************************************
 * @file    ApkInstallerActivity.java
 * @author  Typheye
 * @brief   Installs APK packages through the app installer flow.
 ******************************************************************************
 * @attention
 *
...
public class ApkInstallerActivity extends Activity {
    ...
    private void showAttentionDialog() {
        ...
        builder.setPositiveButton(R.string.adb_ask_yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                BaseMethod.setRunOnce(ApkInstallerActivity.this);
                startInstall(false);
            }
        });
    ...
    private void showBeforeInstallDialog() {
        ...
        final View view = layoutInflater.inflate(R.layout.dialog_content_before_install, findViewById(R.id.dialog_layout_before_install));
        ...
        builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                InstallMethod.installApk(ApkInstallerActivity.this, showInstallDialog(), Apk_Path, Apk_Name, Apk_Icon, pkgName);
            }
        });
    ...
    private Dialog showInstallDialog() {
        LayoutInflater layoutInflater = getLayoutInflater();
        View view = layoutInflater.inflate(R.layout.dialog_content_install, findViewById(R.id.dialog_layout_install));
        AlertDialog.Builder builder = new AlertDialog.Builder(ApkInstallerActivity.this);
        builder.setTitle(Apk_Name);
        builder.setIcon(Apk_Icon);
