...
public class f11 extends iActivity {

public void onCreate(android.os.Bundle be){
super.onCreate(be);
setContentView(open.cn.awg.pro.R.layout.f11);
...
st.xdbj(open.cn.awg.pro.R.id.f11_v).shxtck(true);
...
st.xdbj(open.cn.awg.pro.R.id.f11_v).shxtck(false);
...
java.lang.String set1="/data/user/0/open.cn.awg.pro/settings/f11/set1.inf";
...
if(zf.dy(st.wb(open.cn.awg.pro.R.id.Tab).zf(),"< 腕上微聊")){
...
java.lang.String set="/data/user/0/open.cn.awg.pro/settings/f11/set1.inf";
...
__layoutIsLoaded(ay, vw);
    ...
    public final f11 lei = this, 类 = this;
}
