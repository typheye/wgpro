...
public class AboutAppActivity extends iActivity {
    ...
    public void eggs() {
        ...
        java.lang.String a2 = com.kingqi.zwcj.应用工具.获取应用签名(lei, "open.cn.awg.pro");

        java.lang.String a3 = com.kingqi.zwcj.日期工具.格式化日期时间(com.kingqi.zwcj.应用工具.获取应用第一次安装日期(lei, "open.cn.awg.pro"));

        java.lang.String a4 = com.kingqi.zwcj.日期工具.格式化日期时间(com.kingqi.zwcj.应用工具.获取应用更新日期(lei, "open.cn.awg.pro"));

        java.lang.String a5 = com.kingqi.zwcj.应用工具.获取应用的安装市场(lei, "open.cn.awg.pro");

        java.lang.String a6 = com.kingqi.zwcj.应用工具.获取应用版本名称(lei, "open.cn.awg.pro");

        int a7 = com.kingqi.zwcj.应用工具.获取应用版本号(lei, "open.cn.awg.pro");

        java.lang.String a8 = com.kingqi.zwcj.应用工具.获取应用名称(lei, "open.cn.awg.pro");
