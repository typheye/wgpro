...
import i.app.iActivity;
 import android.graphics.Bitmap; import android.content.pm.ActivityInfo; import android.view.WindowManager; import android.view.Window; import android.os.Build; import android.view.View; import java.lang.reflect.Field; import java.lang.reflect.Method; import com.ypz.bangscreentools.BangScreenTools;import java.lang.*;

public class l5_a6_wearo_d0314_y2023 extends iActivity {

public void onCreate(android.os.Bundle be){
super.onCreate(be);
setContentView(open.cn.awg.pro.R.layout.l5_a6_wearo_d0314_y2023);
...
st.xdbj(open.cn.awg.pro.R.id.l5_a6_wearo_d0314_y2023_v).shxtck(true);
...
st.xdbj(open.cn.awg.pro.R.id.l5_a6_wearo_d0314_y2023_v).shxtck(false);
...
spq=lb.v7lbspq(c22.class,open.cn.awg.pro.R.layout.c22);

int[] kj=new int[]{open.cn.awg.pro.R.id.wb1,open.cn.awg.pro.R.id.wb2,-1,-2};

java.lang.String[] jk=new java.lang.String[]{"","",""};
jk=new java.lang.String[]{"开启蓝牙","开启设备蓝牙并向周围设备显示","com.google.android.apps.wearable.settings","com.google.android.clockwork.settings.connectivity.bluetooth.BluetoothRequestDiscoverableActivity"};
spq.j(kj,jk);
jk=new java.lang.String[]{"eSIM状态","查看eSIM状态","com.google.android.apps.wearable.settings","com.google.android.clockwork.settings.cellular.EsimProfileActivity"};
spq.j(kj,jk);
jk=new java.lang.String[]{"eSIM重置","重置eSIM虚拟卡","com.google.android.apps.wearable.settings","com.google.android.clockwork.settings.cellular.ResetEsimActivity"};
spq.j(kj,jk);
jk=new java.lang.String[]{"账号","查看设备上的账号","com.google.android.apps.wearable.settings","com.google.android.clockwork.settings.cellular.PhoneAccountsActivity"};
spq.j(kj,jk);
jk=new java.lang.String[]{"Wear云同步","启用Wear云同步","com.google.android.apps.wearable.settings","com.google.android.clockwork.settings.CloudSyncOptInSettingsActivity"};
spq.j(kj,jk);
jk=new java.lang.String[]{"Google账号","添加一个Google账号","com.google.android.wearable.app","com.google.android.clockwork.home.accounts.AddAccountActivity"};
spq.j(kj,jk);
spq.sx();
...
__layoutIsLoaded(ay, vw);
    ...
    public final l5_a6_wearo_d0314_y2023 lei = this, 类 = this;
}
