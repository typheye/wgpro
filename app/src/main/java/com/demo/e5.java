...
public class e5 extends ImageView  {
  ...
  */
  ...
  public boolean canScrollHorizontally(int direction) {
    if (mPinchMode == e5.PINCH_MODE_SCALE) {
      return true;
    }
  ...
  */
  public interface OuterMatrixChangedListener {
    ...
    */
    void onOuterMatrixChanged(e5 pinchImageView);
  }
  ...
  */
  ...
  public e5(Context context, AttributeSet attrs) {
    super(context, attrs);
    initView();
  }
  
  public e5(Context context, AttributeSet attrs, int defStyle) {
  ...
  * 在onTouchEvent末尾被执行.
  */
  private GestureDetector mGestureDetector = new GestureDetector(e5.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
    ...
    public void onLongPress(MotionEvent e) {
      ...
      if (mOnLongClickListener != null) {
        mOnLongClickListener.onLongClick(e5.this);
      }
    }
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
      ...
      if (mOnClickListener != null) {
        mOnClickListener.onClick(e5.this);
      }
      return true;
    }
  });
