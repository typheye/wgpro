...
class Storage {
  constructor() {
    this.defSettings = {
      ...
      wgsettings_td_saveProcess: false,
      wgsettings_td_disableTouch: false,
      wgsettings_td_useTouchUD: false,
      wgsettings_td_fontSize: 25,
      wgsettings_td_fontColor: "#FFFFFF",
      wgsettings_td_backgroundColor: "#000000",
